...
write_to_db(BDI_adm0, "BDI_adm0")
write_to_db(BDI_adm1, "BDI_adm1")
write_to_db(BDI_adm2, "BDI_adm2")

write_to_db(COD_adm0, "COD_adm0")
write_to_db(COD_adm1, "COD_adm1")
write_to_db(COD_adm2, "COD_adm2")

write_to_db(UGA_adm0, "UGA_adm0")
write_to_db(UGA_adm1, "UGA_adm1")
write_to_db(UGA_adm2, "UGA_adm2")
...
# Will write an email asking them to add RWA

RWA_adm0 <- st_read(here::here("data/rwa_adm_2006_nisr_wgs1984_20181002_shp/rwa_adm0_2006_NISR_WGS1984_20181002.shp"))
RWA_adm1 <- st_read(here::here("data/rwa_adm_2006_nisr_wgs1984_20181002_shp/rwa_adm1_2006_NISR_WGS1984_20181002.shp"))
RWA_adm2 <- st_read(here::here("data/rwa_adm_2006_nisr_wgs1984_20181002_shp/rwa_adm2_2006_NISR_WGS1984_20181002.shp"))

write_to_db(RWA_adm0, "RWA_adm0")
write_to_db(RWA_adm1, "RWA_adm1")
write_to_db(RWA_adm2, "RWA_adm2")
...
write_to_db(East_COD, "COD_east_adm2")

# Step 2: Merge with adm2 of the other countries. To bin the data together, they all need the same column names.
# Some come a french server and some from the english server. So we must tweak names a bit for them to match exacty. 
...
# This requires renaming and dropping by hand, which limits the reproducibility.
